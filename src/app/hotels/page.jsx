...
import HotelTable from '../tablePages/HotelTable';
import AddHotel from '../addPages/AddHotel';
import PreviewHotel from '../previewPages/PreviewHotel';
...
const Hotels = ({ role }) => {
    ...
    return (
        <main className="flex flex-col lg:flex-row w-full p-4 -mt-5 gap-5 justify-between overflow-x-auto">
            <Sidebar1 />
